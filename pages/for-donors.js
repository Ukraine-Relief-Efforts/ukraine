  ...
  return (
    <Layout>
      <div className="w-full md:w-3/4 lg:w-2/3 pb-16">
        <Hero
          title="For donors"
          description="We’ve compiled some helpful information to give you a better understanding of how to pick the right project to support, and how to transfer funds."
        />
        <div className="mt-24">
          ...
          <div className="mt-8">
            <p>
              We have created this website to help Ukrainian fundraisers reach
              international supporters. problem statement:
            </p>
            <br />
            <p>
              One of our main goals was to make evaluation of smaller
              volunteer-driven fundraisers simple.Much of the work on
              coordinating emergency humanitarian aid to Ukrainians is done by
              volunteers.These are friends and family members of people who need
              help, political activists, and self-organized groups within the
              Ukrainian diaspora worldwide.They are in direct contact with
              people on the ground and understand their immediate needs
              best.They know what’s needed and where and help coordinate
              fundraising, purchase, and delivery of medical supplies, safety
              equipment, food etc.
            </p>
          </div>
        </div>
